        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                        d: "M9.08984 9.00002C9.32495 8.33169 9.78929 7.76811 10.4001 7.40913C11.0109 7.05014 11.7289 6.91894 12.4272 7.03871C13.1255 7.15849 13.7744 7.52152 14.2798 8.06342C14.7852 8.60533 15.1224 9.29477 15.2471 10.034C15.3718 10.7733 15.2758 11.5332 14.9696 12.2149C14.6634 12.8966 14.1594 13.4687 13.5215 13.8542C12.8836 14.2397 12.1464 14.4173 11.4023 14.3615C10.6582 14.3057 9.96206 14.0195 9.40984 13.54",
                        stroke: "currentColor",
                        strokeWidth: "2",
                        strokeLinecap: "round",
                        strokeLinejoin: "round"
...
let questions = [
    {
        id: '1',
        title: 'How to use server components in Next.js 14?',
        content: 'I\'m new to Next.js and trying to understand the difference between server and client components. Can someone explain the best practices for fetching data in a server component?',
        tags: [
            'Next.js',
            'React',
            'Firebase'
        ...
        answers: [
            {
                id: 'a1',
                author: users[1],
                content: 'You can directly use async/await in server components. Just define an async function and fetch your data there. No need for useEffect!',
    ...
    {
        id: '2',
        title: 'What\'s the best way to manage state in Flutter?',
        content: 'I have a complex app and I\'m not sure which state management solution to use. I\'ve looked at Provider, BLoC, and Riverpod. What are the pros and cons?',
        tags: [
            'Flutter',
            'State Management'
        ],
        ...
        answers: [
            {
                id: 'a2',
                author: users[3],
                content: 'Riverpod is great for compile-time safety and simplicity. BLoC is more structured and good for very large applications.',
                createdAt: new Date(Date.now() - 1000 * 60 * 25)
            },
            {
                id: 'a3',
                author: users[0],
                content: 'I started with Provider and it\'s the simplest to get started with. I\'d recommend it for smaller projects.',
    ...
    {
        id: '3',
        title: 'How to implement Google Sign-In with Firebase?',
        content: 'I am trying to add Google authentication to my web app using Firebase. I followed the docs but I am getting a configuration error. Any tips?',
        tags: [
            'Firebase',
            'Authentication'
        ],
...
// Mock API
const simulateLatency = (data)=>new Promise((resolve)=>setTimeout(()=>resolve(data), 500));
const getQuestions = ()=>simulateLatency(questions.sort((a, b)=>b.createdAt.getTime() - a.createdAt.getTime()));
const getQuestionById = (id)=>simulateLatency(questions.find((q)=>q.id === id));
const addQuestion = (question)=>{
    ...
    return simulateLatency(newQuestion);
};
const addAnswer = (questionId, answer)=>{
    ...
    return simulateLatency(newAnswer);
};
const getLeaderboard = ()=>{
    const sortedUsers = [
        ...users
    ].sort((a, b)=>b.score - a.score);
    return simulateLatency(sortedUsers);
};
}}),
...
function QuestionForm() {
    ...
    async function onSubmit(values) {
        ...
        form.reset();
    // Here you would typically re-validate or refresh the question list
    }
...
function QuestionList() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchQuestions = async ()=>{
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getQuestions"])();
            setQuestions(data);
            setLoading(false);
        };
        fetchQuestions();
                    ...
                    children: user ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$questions$2f$QuestionForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["QuestionForm"], {}, void 0, false, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-sm text-muted-foreground",
                                    children: "Please sign in to post a question to the community."
                                }, void 0, false, {
                                    fileName: "[project]/src/components/dashboard/Dashboard.tsx",
                                    lineNumber: 26,
                                    columnNumber: 17
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d53aafb0._.js.map