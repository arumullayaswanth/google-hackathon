...
const firebaseConfig = {
    ...
    storageBucket: "askfast-jpn57.firebasestorage.app",
...
const addQuestion = async (question)=>{
    if (!question.author || !question.author.uid) {
        throw new Error('User must be authenticated to post a question.');
    }
...
const addAnswer = async (questionId, answer)=>{
    if (!answer.author || !answer.author.uid) {
        throw new Error('User must be authenticated to post an answer.');
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d75322e7._.js.map