        ...
        "QuestionList.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onQuestionsSnapshot"])({
                "QuestionList.useEffect.unsubscribe": (data)=>{
                    setQuestions(data);
                    // The loading state will be managed based on whether questions are present or not
                    if (data.length > 0) {
                        setLoading(false);
                    }
                }
...
_s(QuestionList, "M0/dPKJD/6e6shbCgmA8dqv/YLo=");
_c = QuestionList;
var _c;
...
//# sourceMappingURL=src_c13bfe77._.js.map