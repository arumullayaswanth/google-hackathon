    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuestionList.useEffect": ()=>{
            const fetchQuestions = {
                "QuestionList.useEffect.fetchQuestions": async ()=>{
                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getQuestions"])();
                    setQuestions(data);
                    setLoading(false);
                }
            }["QuestionList.useEffect.fetchQuestions"];
            fetchQuestions();
        }
    }["QuestionList.useEffect"], []);
    if (loading) {
...
_s(QuestionList, "hQsoyP7dP+PYL/t0c73K0xJq3/w=");
_c = QuestionList;
var _c;
...
//# sourceMappingURL=src_83ce4b1b._.js.map